...
//-------------- добавляем одну книгу 
                ...
                //  name, publisher,возраст число и единицы,id, price, currencyId, categoryId, [price from - "цена от ххх руб." ]
$offer = $y->book('Все не так.', 'Эксмо',16,'year', 'id01id1111', 900, "USD",15 /* , true*/ );
    ...
    $offer  ->isbn('978-5-94878-004-7')                             // !!!  условно обязательный. ISBN, можно несколько через запятую
            ...
            ->pages(288)                                            //      page_extent Количество страниц
...
<p>ну и теги можно ставить здесь</p>'
 ,true)            
            ...
            ->param('Качество картинок','600','dpi')                //      Параметры из поиска на маркете
            ->param('Переплет','твердый')                           //      Не заметил развитого поиска по книгам, скорее не нужен
