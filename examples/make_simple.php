...
$fileName = __DIR__ . '/files/simple.xml';
...
$yml
    ...
    ->bufferSize(1024 * 1024 * 16);         //      если не нравится размер файлового буфера в php по умолчанию,байт
...
$yml
    ...
    ->agency('Webdivision.ru')             //      Агентство, отвечающее за работоспособность сайта
