...
//-------------- добавляем один тур
                ...
                // name,days,included,transport, id, price, currencyId, categoryId    , [price from - "цена от ххх руб." ]

$offer = $y->tour( 'Hilton',7,'авиаперелет, трансфер, проживание, питание, страховка','Авиа', 'id01id1111', 900, "USD", 15 /* , true*/ );

    $offer  ->worldRegion('Африка')                             //      Часть света.
